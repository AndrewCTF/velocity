...
export const defaultLayers: readonly LayerDescriptor[] = [
  ...
  // ── 2026-07-14 KEYLESS DATA-LAYERS WAVE (12 feeds) ───────────────────────
  // See docs/data-layers-wave-2026-07-14-plan.md. Point hazards → 'hazard'
  // style, fire/sigmet areas → 'hazardpoly', power plants → 'facility'
  // (dispatched in LayerCompositor by id). All keyless, all off by default.
  {
    id: 'hazards.gdacs',
    group: 'hazards',
  ...
  },
  {
    ...
    time: { temporal: true },
    crs: 'EPSG:4326',
    license: 'NIFC / WFIGS (public domain)',
    opacity: 0.6,
    visibleByDefault: false,
    emits: ['fire'],
  },
  {
    ...
    time: { temporal: true },
    crs: 'EPSG:4326',
    license: 'NOAA NHC (public domain)',
    opacity: 1,
    visibleByDefault: false,
    emits: ['event'],
  },
  ...
  },
  {
    ...
    kind: 'geojson',
    auth: 'none',
    endpoint: '/api/maritime/chokepoints',
    refresh: { mode: 'pull', ttlSec: 60 },
    time: { temporal: true },
    crs: 'EPSG:4326',
    license: 'Derived from keyless AIS union',
    opacity: 1,
    visibleByDefault: false,
    emits: ['event'],
  },
  ...
  },
  {
    ...
    time: { temporal: false },
    crs: 'EPSG:4326',
    license: 'WRI Global Power Plant DB (CC BY 4.0)',
    opacity: 1,
    visibleByDefault: false,
  },
  {
    id: 'aviation.sigmet',
    group: 'aviation',
    title: 'SIGMET / AIRMET hazards',
    kind: 'geojson',
    auth: 'none',
    endpoint: '/api/aviation/sigmet',
    refresh: { mode: 'pull', ttlSec: 600 },
    time: { temporal: true },
    crs: 'EPSG:4326',
    license: 'NOAA AWC (public domain)',
    opacity: 0.5,
    visibleByDefault: false,
    emits: ['event'],
  },
