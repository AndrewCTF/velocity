...
[![Tests](https://img.shields.io/badge/tests-2628%20passing-brightgreen.svg)](#tests)
...
OSINT_DISABLE_BACKGROUND=1 apps/api/.venv/bin/pytest apps/api -q   # 2628 passed + 2 skipped
